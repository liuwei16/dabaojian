# Generated by Django 4.2.9 on 2024-02-02 09:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bid_count', models.PositiveIntegerField(default=0, verbose_name='出价次数')),
                ('look_count', models.PositiveIntegerField(default=0, verbose_name='围观次数')),
                ('auction', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.auction', verbose_name='拍卖专场')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.auction', verbose_name='拍卖专场')),
                ('item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.auctionitem', verbose_name='拍品')),
